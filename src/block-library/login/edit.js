...
export default function Edit() {
	return (
		<div { ...useBlockProps() } >
			<InnerBlocks
				template={[	[ 'core/heading', { placeholder: 'Heading' } ] ]}
				templateLock="insert"
			/>
			<div class="login">
				<form name="loginform" id="loginform" action="http://wordpress.com.devel/wp-login.php" method="post">
					<p class="login-username">
						<input type="text" name="log" id="user_login" autocomplete="username" class="input" value="" size="20" placeholder={ __('Username or Email Address' , 'g-blocks') } />
					</p>
					<p class="login-password">
						<input type="password" name="pwd" id="user_pass" autocomplete="current-password" class="input" value="" size="20" placeholder={ __('Password' , 'g-blocks') }/>
					</p>
